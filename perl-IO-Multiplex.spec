...
Requires: perl-IO-Multiplex-license
Requires: perl-IO-Multiplex-man
...
%package man
Summary: man components for the perl-IO-Multiplex package.
Group: Default

%description man
man components for the perl-IO-Multiplex package.
...
mkdir -p %{_topdir}/BUILD/IO-Multiplex-1.16/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-IO-Multiplex
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-IO-Multiplex/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/IO/Multiplex.pm

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-IO-Multiplex/deblicense_copyright
